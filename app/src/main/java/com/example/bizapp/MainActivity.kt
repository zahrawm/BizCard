...
import com.example.bizapp.ui.theme.BizAppTheme
            ...
            shape =  RectangleShape,  elevation = 4.dp
                ...
                Row(modifier = Modifier
                    ...
                    Column(modifier = Modifier.padding(7.dp).align(alignment= Alignment.CenterVertically )) {
                        ...
                        Text( text ="A great developer",  style = MaterialTheme.typography.body2)
...
private fun CreateImageProfile(modifier: Modifier = Modifier) {
    Surface(
        ...
        Image(
            painter = painterResource(id = R.drawable.baby), contentDescription = "profile image",
